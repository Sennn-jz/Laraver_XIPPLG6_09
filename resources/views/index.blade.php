...
<body>
    ...
    <section class="section">
        ...
        <div class="features">
            ...
            <div class="feature">
                ...
                <p>Enjoy premium quality sushi at reasonable prices that offer great value for your dining experience.</p>
            </div>
            <div class="feature">
                <div class="feature-icon">
                ...
                <h3>Fast Delivery</h3>
                <p>Our efficient delivery service ensures your sushi arrives fresh and delicious right at your doorstep.</p>
            </div>
        </div>
    </section>
    ...
    <footer id="contact">
        ...
        <div class="copyright">
            &copy; {{ date('Y') }} SUSHI. All Rights Reserved.
        </div>
    </footer>
